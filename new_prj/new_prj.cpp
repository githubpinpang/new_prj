...
static guint16
dissect_sccp_parameter(tvbuff_t *tvb, proto_tree *sccp_tree,
	...
	guint8 parameter_type, guint16 offset)
{
	...
	dissect_sccp_parameter(tvb, sccp_tree, parameter_type, offset,
		parameter_length);
  ...
  do {                                                                  \
   ...
   /* proto_tree_add_uint(sccp_tree, hf_sccp_optional_pointer, tvb,       \
	...
	case SCCP_MSG_TYPE_CR:
		...
		printf("message type %u \n", SCCP_MSG_TYPE_CR);
		offset += dissect_sccp_parameter(tvb, sccp_tree,
...
//assoc = get_sccp_assoc( msg_offset, slr, dlr, message_type);
		...
		dissect_sccp_variable_parameter(tvb, sccp_tree,
	...
	case SCCP_MSG_TYPE_UDT:
		...
		dissect_sccp_variable_parameter(tvb, sccp_tree, PARAMETER_DATA,
			variable_pointer3);
